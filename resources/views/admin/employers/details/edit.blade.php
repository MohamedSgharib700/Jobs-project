                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form
                                    action="{{ route('admin.employer.details.update',['employer'=>$employer,'details' => $employerDetails]) }}"
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 col-xl-6 col-md-12 col-sm-12 mx-auto">
                                                <div class="card">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-12">
                                                                ...
                                                                <div class="form-group ">
                                                                    <label
                                                                        for="exampleInputname"> {{ trans('company_name') }}</label>

                                                                    <input type="text" class="form-control"
                                                                           name="company_name" id="company_name"
                                                                           value="{{old('company_name',$employerDetails->company_name)}}"
                                                            ...
                                                            <div class="col-lg-6 col-md-12">
                                                                <div class="form-group">
                                                                    <label
                                                                        for="exampleInputEmail1">{{ trans('company_industry') }}</label>

                                                                    <select class="select2 col-md-12" name="industry_id">
                                                                        <option
                                                                            value="">{{ trans('select_company_industry') }}</option>
                                                    ...
                                                    <div class="form-group">
                                                        <label
                                                            for="exampleInputname"> {{ trans('select_company_size') }}</label>
                                                        <div class="form-group">

                                                            <select class="select2 col-md-12" name="company_size" >
                                                                <option
                                                                    value="">{{ trans('select_company_size') }}</option>
                                                                @foreach(CompanySize::getList() as $key => $value)
                                                                    <option
                                                                        value="{{ $key }}" {{ (($employerDetails->company_size== $key) or (old("company_size") == $key) ) ? "selected":null }}>
                                                                        {{ $value }}
                                                                    </option>
                                                                @endforeach
                                                            </select>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            <input type="text" class="form-control" name="job_title"
                                                                   id="job_title"
                                                                   value="{{old('job_title',$employerDetails->job_title)}}"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            <!-- <label for="exampleInputEmail1">مجال الشركه</label> -->
