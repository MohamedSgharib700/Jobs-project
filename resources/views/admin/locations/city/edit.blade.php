            ...
            <div class="section-body">
                ...
                <div class="row">
                    ...
                    <div class="card">
                        ...
                        <h4> {{trans('edit_city')}}</h4>
                        </div>
                        <div class="card-body">
                        <form method="POST"action="{{ route('admin.cities.update', ['city' => $city]) }}" method="post" id="horizontal-validation" class="form-horizontal" enctype="multipart/form-data" >
                            @csrf
                            @method('PUT')
                            <div class="form-group row">
                                <label for="ar_name" class="col-md-3 col-form-label">{{trans('ar_name')}}</label>
                                <div class="col-md-9">
                                    <input type="text" class="form-control " name="ar[name]" value="{{$city->translate('ar')->name}}" id="ar_name" >
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9"> 
                                    <input type="text" class="form-control" name="en[name]" value="{{$city->translate('en')->name}}" id="en_name" >
                            ...
                            <input type="hidden" name="parent_id" value="{{$city->parent_id}}">
